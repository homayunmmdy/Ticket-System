      ...
      <div className="flex mb-3">
        ...
        <div className="ml-auto">
          ...
          <Link href={`/TicketPage/${ticket._id}`} style={{ display: "contents" }}>
            <button
              type="button"
              className="focus:outline-hidden text-white bg-amber-700 hover:bg-amber-800 focus:ring-4 focus:ring-amber-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2"
            >
              <FaEdit />
            </button>
          </Link>
